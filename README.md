...
The interface uses a photographic teal ocean, warm ivory display type, translucent panels, clear SVG controls and a responsive layout. Mobile safe areas, reduced motion, keyboard chart access, dialog focus restoration and station-local times are supported.
